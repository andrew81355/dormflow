...
function renderAnnouncement(announcement) {
    ...
    meta.className = 'meta';
    const author = announcement.createdBy && announcement.createdBy.name ? announcement.createdBy.name : 'administration';
...
async function loadAnnouncements() {
    ...
    announcements.forEach((announcement) => announcementList.append(renderAnnouncement(announcement)));
}
// delete announcement
